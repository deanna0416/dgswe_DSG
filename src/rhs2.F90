...
!$OMP                    npart,nrblk,elblk,nfblk,rnfblk,npartet)
      ...
      DO et = 1,nel_type
        ...
        IF (npartet(et,blk) > 0) THEN
          CALL interior_edge_eval(ete,elblk(1,blk,et),elblk(2,blk,et),ndof(et),nverts(ete)*nqpte(ete)) !**** do I really want nverts here?!?!
        ENDIF
      ENDDO
      ...
      DO blk = 2,npart+1
        DO et = 1,nel_type
          ...
          IF (npartet(et,blk) > 0) THEN
            !****
            CALL interior_edge_eval_ldg_Q(ete,elblk(1,blk,et),elblk(2,blk,et),ndof(et),nverts(ete)*nqpte(ete))
          ENDIF
      ...
      DO blk = 1,npart+1
        DO et = 1,nel_type
          ...
          IF (npartet(et,blk) > 0) THEN
!****
            CALL edge_integration_ldg(ete,elblk(1,blk,et),elblk(2,blk,et),ndof(et),nverts(ete)*nqpte(ete))
...
!****
        IF (npartet(et,blk) > 0) THEN
          CALL interior_edge_eval_ldg_E(ete,elblk(1,blk,et),elblk(2,blk,et),ndof(et),nverts(ete)*nqpte(ete))!****g
        ENDIF
      ENDDO
...
!$OMP do
       ...
       DO blk = 2,npart+1
        DO et = 1,nel_type
          ...
          IF (npartet(et,blk) > 0) THEN
            CALL interior_edge_eval(ete,elblk(1,blk,et),elblk(2,blk,et),ndof(et),nverts(ete)*nqpte(ete))!****
            IF (esl > esl_tol) THEN
              CALL interior_edge_eval_ldg_E(ete,elblk(1,blk,et),elblk(2,blk,et),ndof(et),nverts(ete)*nqpte(ete))!****
            ENDIF
          ENDIF
        ENDDO
...
!$OMP do
      DO blk = 1,npart+1
        DO et = 1,nel_type
          ...
          IF (npartet(et,blk) > 0) THEN
!****
            CALL edge_integration(ete,elblk(1,blk,et),elblk(2,blk,et),ndof(et),nverts(ete)*nqpte(ete))
