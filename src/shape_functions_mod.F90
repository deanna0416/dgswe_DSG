...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      ldv = (p+1)**2 !ldv is lda for intel mkl an: INTEGER. The leading dimension of the array V
      ...
      IF (calc_derv == 0) THEN
        ...
        CALL DGESV(nnd,npts,V,ldv,ipiv,psi,ldp,info) !ndof, nqa+nqe, Vand, ldv, output: ipiv, psi = b (rhs of minverse), ldp
