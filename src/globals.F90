...
!       REAL(rp), PARAMETER :: r_earth = 6.340304248283833d6
      ...
      INTEGER, PARAMETER :: nel_type = 5 !(type #s: 1 -> triangles, 2 -> quads, 3 -> curved triangles, 4-> curved quads)
      INTEGER, PARAMETER :: norder = 7 ! # of different orders (straight sided elements for tri/quad = 1, curvilinear tri/quad = ctp, high-order bathymetry = hbp)
