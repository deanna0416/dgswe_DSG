...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      DO et = 1,2
        ...
        CALL element_nodes(et,1,np(crv_typ),npts,r,s) ! output is npts, r, s
        CALL shape_functions_area_eval(et,np(str_typ),nnd,npts,r,s,psi(:,:,et)) ! output is nnd, psi
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      INTEGER, INTENT(IN) :: nnfbed                       ! total number of no normal flow boundaries
      INTEGER, DIMENSION(:), INTENT(IN) :: nfbedn         ! array of no normal flow boundary edge numbers
      ...
      DO ed = 1,nnfbed
        ...
        n1ind = 0
 search:DO i = 1,fbseg(1,seg)-1 ! number of nodes and type of each normal flow boundary segment (1,seg) = # nodes, (2,seg) = type
