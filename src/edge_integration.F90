...
!DIR$ SIMD
          ...
          ENDDO ed_points
!          PRINT"(A)",'Zqpt in edge_integration'
!          PRINT*,Zqpt
!          PRINT"(A)",'Hqpt in edge_integration'
!          PRINT*,Hqpt
!          PRINT"(A)",'recipHa in edge_integration'
!          PRINT*,recipHa
!          PRINT"(A)",'xmom in edge_integration'
!          PRINT*,xmom
!          PRINT"(A)",'xmyom in edge_integration'
!          PRINT*,xymom
