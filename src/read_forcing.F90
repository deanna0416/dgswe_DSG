      ...
      DO seg = 1,nbou
        segtype = fbseg(2,seg)   ! fbseg is number of nodes and type of each normal flow boundary segment
...
!                PRINT "(I5, I5, I5)",nd, seg, bfr
      ...
      IF (myrank == 0) THEN
        ...
        IF (nobfr > 0) THEN
          ...
          ENDDO
        ENDIF
        PRINT "(A,I5)", 'Number of elevation specified bound nodes (neta)',neta
